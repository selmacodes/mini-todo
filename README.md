...
Konsolbaserad todo-app från lektion 2 - JavaScript 1. 
...
- **Markera som avklarad (`completeTodo`)** - Ändrar status på todo till `true`
- **Visa ej avklarade (`showPendingTodos`)** - Visar todos som inte är klara (`filter`)